...
def test_xai_tools_mode_no_raw_response():
    """Test that XAI_TOOLS mode does not add _raw_response attribute"""
    ...
    # Verify that _raw_response attribute does NOT exist for XAI_TOOLS mode
    assert not hasattr(user, "_raw_response"), "XAI_TOOLS mode should not have _raw_response attribute"
